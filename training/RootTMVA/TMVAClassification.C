...
int TMVAClassification( TString myMethodList = "" )
{
   ...
   TFile *input(0);
   TString datasets = "/home/loren/MSc/datasets/";
   TString fname = datasets + "Lc_sample_1000files_2016MagDown.root";
   ...
   TTree *signalTree     = (TTree*)input->Get("LcKPiTree");
   TTree *background     = (TTree*)input->Get("LcKPiTreeWS1");

   cout << signalTree << " " << background << endl;
   ...
   dataloader->AddVariable( "Lc_p", 'F' );
   dataloader->AddVariable( "Lc_PT",'F' );
   dataloader->AddVariable( "Lc_PZ",'F' );
   dataloader->AddVariable( "Lc_M",'F' );
