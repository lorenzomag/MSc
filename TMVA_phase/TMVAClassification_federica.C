...
int TMVAClassification( TString myMethodList = "" )
{
   ...
   //TString fname = "/eos/lhcb/wg/Charm/Xic2LcK_temp/LcK_Turbo_2016_MagDown.root";
   //TString fname = "/eos/lhcb/wg/Charm/Xic2LcK_temp/LcK_Turbo_2016_MagDown.root";
  // TString fname = "/eos/lhcb/user/f/feoliva/Analysis/XicpStStToLcKPi_all.root";
  // TString fname = "/eos/lhcb/user/f/feoliva/Analysis/May/XicpStStToLcKPi_all.root";

   //TString fname = "/eos/lhcb/user/f/feoliva/Analysis/Xicpstar_100files/XicpStStToLcKPi_all.root";
   //TString fname = "/eos/lhcb/user/f/feoliva/Analysis/Xicp_newvar/XicpStStToLcKPi_var_all.root";
   //TString fname = "/eos/lhcb/user/f/feoliva/Analysis/LcStudy_sweights.root";
   TString fname = "/eos/lhcb/user/f/feoliva/Lc2pKpi/LcStudy_sweights.root";
   ...
   //dataloader->AddVariable("Lc_M", "Lc_M", "", 'F');
    ...
    dataloader->AddVariable("log(Lc_ENDVERTEX_CHI2)", "Lc_ENDVERTEX_CHI2", "", 'F');
   // dataloader->AddVariable("log(1-Lc_DIRA_OWNPV)", "Lc_DIRA_OWNPV", "", 'F');
    //dataloader->AddVariable("log(Lc_IPCHI2_OWNPV)", "Lc_IPCHI2_OWNPV", "", 'F');
    dataloader->AddVariable("log(Lc_FDCHI2_OWNPV)", "Lc_FDCHI2_OWNPV", "", 'F');
    
    
    dataloader->AddVariable("log(p_PT)", "p_PT", "", 'F');
    dataloader->AddVariable("log(p_IPCHI2_OWNPV)", "p_IPCHI2_OWNPV", "", 'F');
    dataloader->AddVariable("1-sqrt(1-p_ProbNNp)", "p_ProbNNp", "", 'F');
    
    //dataloader->AddVariable("log(Km_PT)", "Km_PT", "", 'F');
    //dataloader->AddVariable("log(Km_IPCHI2_OWNPV)", "Km_IPCHI2_OWNPV", "", 'F');
  //  dataloader->AddVariable("1-sqrt(1-Km_ProbNNk)", "Km_ProbNNk", "", 'F');
    
    //dataloader->AddVariable("log(pip_PT)", "pip_PT", "", 'F');
    dataloader->AddVariable("log(pip_IPCHI2_OWNPV)", "pip_IPCHI2_OWNPV", "", 'F');
    dataloader->AddVariable("1-sqrt(1-pip_ProbNNpi)", "pip_ProbNNpi", "", 'F');
   ...
   //dataloader->SetBackgroundWeightExpression( "sw_back" );
   dataloader->SetSignalWeightExpression( "sw_sig" );  
  ...
  // TCut mycutb = ""; // for example: TCut mycutb = "abs(var1)<0.5";
   ...
   //TCut mycuts = "Lc_M_DTF_PV > 2268 && Lc_M_DTF_PV < 2305"; // signal region
  // TCut mycutb = "(Lc_M_DTF_PV > 2230 && Lc_M_DTF_PV < 2250) || (Lc_M_DTF_PV > 2320 && Lc_M_DTF_PV < 2340)"; // sidebands 


  // TCut mycuts = "Lc_M > 2275 && Lc_M < 2295"; // signal region
...
//                                        "nTrain_Signal=1000:nTrain_Background=1000:SplitMode=Random:NormMode=NumEvents:!V" );
   ...
   if (Use["Fisher"])
      factory->BookMethod( dataloader, TMVA::Types::kFisher, "Fisher", "V:Fisher:VarTransform=None:CreateMVAPdfs:PDFInterpolMVAPdf=Spline2:NbinsMVAPdf=50:NsmoothMVAPdf=10" );
