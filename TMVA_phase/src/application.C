...
void TMVAClassificationApplication(TString myMethodList = "")
{
   ...
   std::array<Float_t,13> vars;

   reader->AddVariable("Xicst_ENDVERTEX_CHI2", &vars[0]);
   reader->AddVariable("Xicst_IPCHI2_OWNPV", &vars[1]);
   reader->AddVariable("Xicst_FDCHI2_OWNPV", &vars[2]);
   reader->AddVariable("Lc_PT", &vars[3]);
   reader->AddVariable("Lc_IPCHI2_OWNPV", &vars[4]);
   reader->AddVariable("Kbach_PT", &vars[5]);
   reader->AddVariable("Kbach_IPCHI2_OWNPV", &vars[6]);
   reader->AddVariable("Kbach_ProbNNk", &vars[7]);
   reader->AddVariable("Xicst_PT", &vars[8]);
   reader->AddVariable("pibach_PT", &vars[9]);
   reader->AddVariable("pibach_IPCHI2_OWNPV", &vars[10]);
   reader->AddVariable("pibach_ProbNNpi", &vars[11]);

   // Spectator variables declared in the training have to be added to the reader, too
   Float_t Xicst_M, Xicst_ID;
   reader->AddSpectator("Xicst_ID", &Xicst_ID);
   ...
   //
   TFile *input(0);
   TString fname = getenv("CURRENT_MC_DATASET");
   ...
   // theTree->Add(getenv("CURRENT_MC_DATASET"));
   theTree->Add(getenv("CURRENT_WS1_DATASET"));
   // theTree->Add(getenv("CURRENT_WS2_DATASET"));
   
   std::array<Double_t,13> tree_vars;

   theTree->SetBranchAddress("Xicst_ENDVERTEX_CHI2", &tree_vars[0]);
   theTree->SetBranchAddress("Xicst_IPCHI2_OWNPV", &tree_vars[1]);
   theTree->SetBranchAddress("Xicst_FDCHI2_OWNPV", &tree_vars[2]);
   theTree->SetBranchAddress("Lc_PT", &tree_vars[3]);
   theTree->SetBranchAddress("Lc_IPCHI2_OWNPV", &tree_vars[4]);
   theTree->SetBranchAddress("Kbach_PT", &tree_vars[5]);
   theTree->SetBranchAddress("Kbach_IPCHI2_OWNPV", &tree_vars[6]);
   theTree->SetBranchAddress("Kbach_ProbNNk", &tree_vars[7]);
   theTree->SetBranchAddress("Xicst_PT", &tree_vars[8]);
   theTree->SetBranchAddress("pibach_PT", &tree_vars[9]);
   theTree->SetBranchAddress("pibach_IPCHI2_OWNPV", &tree_vars[10]);
   theTree->SetBranchAddress("pibach_ProbNNpi", &tree_vars[11]);

   Double_t tree_Xicst_M, tree_Xicst_ID;
   theTree->SetBranchAddress("Xicst_ID", &tree_Xicst_ID);
   theTree->SetBranchAddress("Xicst_M", &tree_Xicst_M);
   ...
   for (Long64_t ievt = 0; ievt < theTree->GetEntries(); ievt++)
   {
      ...
      for (auto i : ROOT::TSeqI(tree_vars.size()))
      {
         vars[i] = tree_vars[i];
         if (ievt % 1000 == 0)
            std::cout << "--- Variable " << i << " = " << tree_vars[i] << std::endl;
      }

      Xicst_ID = tree_Xicst_ID;
      Xicst_M = tree_Xicst_M;
